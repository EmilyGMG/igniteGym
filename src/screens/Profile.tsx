...
import { Center, Heading, Input, ScrollView, Skeleton, Text, VStack, useToast } from 'native-base';
...
export function Profile() {
  ...
  const [userPhoto, setUserPhoto] = useState('https://github.com/EmilyGMG.png');
